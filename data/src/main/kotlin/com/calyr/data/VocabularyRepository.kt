...
class VocabularyRepository {
    ...
    fun getVocabularies(): List<VocabularyModel> {
        return listOf(
            ...
            VocabularyModel("a reference", "someone who knows you well and can write a letter about you a skill: an ability to do something well")
        )
    }
}